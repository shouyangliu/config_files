...
static const char *roficmd[] = {"/home/yl/.config/rofi/launchers/type-5/launcher.sh", NULL };
static const char *changebgcmd[] = {"feh", "--randomize", "--bg-fill", "/home/yl/Downloads/wallpaper/", NULL};
